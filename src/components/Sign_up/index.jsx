...
import { schema } from '../../tools/Validation/index';
      ...
      >
        <DialogContent>
          ...
          <Box sx={{ textAlign: 'end' }}>
            <Button onClick={props.handleCloses} sx={{ minWidth: 0, p: 0 }}>
              <CancelSharpIcon
                sx={{
          ...
          >
            ...
            <Button sx={{ textDecoration: 'underline', fontWeight: 'bold' }}>
